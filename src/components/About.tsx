      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="glass-card rounded-3xl p-8 md:p-12 animate-fade-in">
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed text-center">
            ...
            <span className="text-foreground font-semibold">front-end development</span>,{" "}
            <span className="text-foreground font-semibold">Python programming</span>, and{" "}
            <span className="text-foreground font-semibold">AWS cloud deployment</span>. 
